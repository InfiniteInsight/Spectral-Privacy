			...
			{:else if mapBlurRequests.length === 0}
				<div class="rounded-lg border border-gray-200 bg-gray-50 p-8 text-center">
					...
					<button
						...
						class="cursor-pointer rounded-lg bg-primary-600 px-6 py-3 text-white hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50"
					>
					...
					{#each mapBlurRequests as request}
						<div class="rounded-lg border border-gray-200 bg-white p-6">
							...
							<button
								...
								class="cursor-pointer w-full rounded-lg px-4 py-2 text-sm font-medium transition-colors {request.status ===
								'URLGenerated'
